...
import com.jwetherell.motion_detection.MotionDetectionActivity;
...
public class RgbMotionDetection implements IMotionDetection {
    ...
    protected static boolean isDifferent(int[] first, int width, int height) {
        ...
        MotionDetectionActivity.startTime = System.currentTimeMillis();
    ...
    public boolean detect(int[] rgb, int width, int height) {
        ...
        if (motionDetected == true) {
        	//MotionDetectionActivity.startTime = System.currentTimeMillis();
            MotionDetectionActivity.endTime = System.currentTimeMillis();
            MotionDetectionActivity.duration = MotionDetectionActivity.endTime - MotionDetectionActivity.startTime;
            Log.i("Timer", "Time taken is " + MotionDetectionActivity.duration);
        }
